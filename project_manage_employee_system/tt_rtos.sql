...
INSERT INTO `quan_li_nv` (`id`, `name`, `branch`, `phone`, `address`, `hourwork`, `hoursalary`) VALUES
(1, 'bac nguyen', 'IT', 911871, 'hcm city', 100, 30),
(3, 'ngoc thanh', 'Sale', 8234765, 'da nang', 200, 20),
(4, 'nam', 'Support', 22666, 'thu duc', 120, 30),
(6, 'tung', 'Support', 2222, 'qnam', 120, 20);
